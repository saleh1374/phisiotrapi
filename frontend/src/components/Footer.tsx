  ...
  return (
    <footer className="mt-16 bg-navy text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        <div>
          <p className="flex items-center gap-2 text-lg font-bold">
            ...
            کلینیک <span className="text-gold">فیزیوتراپی</span>
          </p>
          <p className="mt-3 text-sm leading-7 text-white/70">
            ارائه‌دهنده خدمات تخصصی فیزیوتراپی، توانبخشی و آموزش‌های تخصصی با
            کادری مجرب و تجهیزات به‌روز.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-3 text-sm text-white/70">
            ...
            <li className="flex items-center gap-2">
              ...
              <span dir="ltr">info@physioclinic.ir</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-white/50">
        © {new Date().getFullYear()} کلینیک فیزیوتراپی — تمامی حقوق محفوظ است.
      </div>
    </footer>
  );
}